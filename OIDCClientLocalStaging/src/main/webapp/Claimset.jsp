        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <form action="http://localhost:8081/OIDCClientLocalStaging/Logout" method="post" >
                  <%
                  ...
                  logoutMap.put("sid",(String)tokenClaims.get("session_id") );
                  logoutMap.put("sub",(String)tokenClaims.get("sub") );
                  String logoutMapJson = new Gson().toJson(logoutMap);
                  %>
                  <input type="hidden" value=<%=logoutMapJson %> name="tokenForLogout"/>
